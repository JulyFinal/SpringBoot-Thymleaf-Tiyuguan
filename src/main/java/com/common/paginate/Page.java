 ...
 */
public class Page {
    private int pageSize = 1000; //每页显示记录数
    ...
    private String addcondiction;

    public String getAddcondiction() {
        return addcondiction;
    }

    public void setAddcondiction(String addcondiction) {
        this.addcondiction = addcondiction;
    }
    ...
    public String getPageStr() {
        ...
        if (totalResult > 0) {
            ...
            for (int i = startTag; i <= totalPage && i <= endTag; i++) {
                if (currentPage == i)
                    sb.append("<a href='javascript:void(0);' class='page-cut'>" + i + "</a>\n");
                else
...
//				}
            ...
            sb.append("	<span>共" + totalPage + "页</span>\n");
            if ("have".equals(type)) {
                sb.append("	<span>	" + pageSize + "条记录,共" + totalResult + "条</span>\n");
            }
            sb.append("</div>\n");
