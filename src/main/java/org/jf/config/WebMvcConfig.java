...
public class WebMvcConfig extends WebMvcConfigurerAdapter {
    ...
    public void addInterceptors(InterceptorRegistry registry) {
        registry.addInterceptor(new LoginInterceptor()).addPathPatterns("/index/mycenter", "/index/addcomment", "/index/addBlog","/index/apply").excludePathPatterns("/index/loginUI", "/index/index", "/index/registerUI","/index/register");
