(function(win){
    ...
    Dialog.prototype = {
        ...
        loadIframe:function(opts){
            ...
            iframe.name = 'dlgiframe';
            iframe.id = 'dlgiframe';
			var clientWidth = document.body.clientWidth;
			var actWidth = clientWidth * 0.8;
            ...
            doms.dialogWindow.removeChild(doms.dialogFooter);
			doms.dialogWindow.removeChild(doms.dialogHeader);
			/**
            doms.btnEnter.onclick = function(){
                _this.close();
                opts.callback && opts.callback.call(_this,true,doms);
            };
			doms.dialogFooter.appendChild(doms.btnCancel);
            doms.btnCancel.onclick = function(){
                _this.close();
    ...
    function setCenter(doms,doc){
        ...
        var dd = doc.body,W = dd.clientWidth,H = dd.clientHeight,dbh = doc.body.offsetHeight;
